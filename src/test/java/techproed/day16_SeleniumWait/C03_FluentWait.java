...
max. belirtmiş olduğumuz süre kadar bizim belirttiğimiz aralıklarda (saniye/salise) bekler
    ...
    public void test01() {
        ...
        wait.withTimeout(Duration.ofSeconds(20)).//-->FluentWait icin max. beklem suresini belirtir
                pollingEvery(Duration.ofMillis(200)).//-->200 milisaniye aralikla webelementin etkilesime girdigini kontrol et
    ...
    public void test03() {
        ...
        Wait<WebDriver> wait1 = new FluentWait<>(driver).
                ...
                pollingEvery(Duration.ofSeconds(200));
        wait1.until(ExpectedConditions.visibilityOf(helloWorldText));
    ...
    public void test04() {
        ...
        //Hello World! Yazının sitede oldugunu test et
        WebElement helloWorldText = driver.findElement(By.xpath("(//h4)[2]"));
        fluentWaitVisible(helloWorldText,20,100);
